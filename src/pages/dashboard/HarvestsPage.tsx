        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2"><Label>Prix/kg (FCFA)</Label><Input type="number" step="any" min="0" placeholder="0" value={form.unit_price_kg} onChange={(e) => setForm({ ...form, unit_price_kg: e.target.value })} /></div>
