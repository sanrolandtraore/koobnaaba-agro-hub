              ...
              <DialogContent>
                ...
                <form onSubmit={handleExpenseSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1"><Label>Montant (FCFA) *</Label><Input type="number" step="any" min="0" placeholder="0" value={expForm.amount} onChange={(e) => setExpForm({ ...expForm, amount: e.target.value })} /></div>
              ...
              <DialogContent>
                ...
                <form onSubmit={handleSaleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-1"><Label>Prix unitaire (FCFA) *</Label><Input type="number" step="any" min="0" placeholder="0" value={saleForm.unit_price} onChange={(e) => setSaleForm({ ...saleForm, unit_price: e.target.value })} required /></div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
