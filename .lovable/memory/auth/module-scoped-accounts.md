...
description: Chaque module (Agriculture & Agronomie, Éleveur, Coop, Partenaire) a son propre compte, identifié par un préfixe de rôle
type: feature
---
...
- Rôles proposés à l'inscription : `agriculteur` (label « Agriculture & Agronomie »), `eleveur`, `cooperative`, `partenaire`.
